...
class RunningRedLightTest(Criterion):
    ...
    def update(self):
        ...
        self.check_tl_state(location, tail_far_pt)
    ...
    def check_tl_state(self, location, tail_far_pt):
        # found_tl is needed so we can stop looking for tl if we found the closest one.
        found_tl = False
