...
from leaderboard.autoagents.autonomous_agent_autopilot import AutonomousAgent, Track
...
class NpcAgent(AutonomousAgent):
    ...
    def setup(self, configs):
        ...
        """
        super(NpcAgent, self).setup(configs)
    ...
    def sensors(self):
        ...
        # sensors = [
        #     {'type': 'sensor.camera.rgb', 'x': 0.7, 'y': -0.4, 'z': 1.60, 'roll': 0.0, 'pitch': 0.0, 'yaw': 0.0,
        #      'width': 256, 'height': 200, 'fov': 100, 'id': 'image'},
        # ]
